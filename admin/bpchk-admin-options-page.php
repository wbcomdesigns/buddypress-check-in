            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onClick="window.open( 'https://developers.google.com/maps/documentation/javascript/', 'pagename', 'resizable,height=600,width=700' ); return false;">
...
<?php } ?>
			...
			<tr>
				...
				<td>
					<input value="<?php echo $saved_range; ?>" id="google_range" type="range" class="regular-text" name="range" min="0" max="10" onchange="updateRangeField( this.value );">
					<span id="range_disp">
						<?php if ( $saved_range ) echo "$saved_range kms."; ?>
					</span>
					<?php $hidden_rnge = empty( $saved_range ) ? 5 : $saved_range; ?>
					<input type="hidden" name="distance" value="<?php echo $hidden_rnge; ?>" id="hidden_range">
				</td>
			</tr>
			<!-- Place Types -->
			<tr>
